...
/**
 * Connector for command nodes
 */
export class NodeConnector extends Phaser.GameObjects.Graphics {
    ...
    constructor(
        ...
        super(scene, {
            lineStyle: {
                width: NodeConnector.LINE_WIDTH,
                color: NodeConnector.DEFAULT_COLOR,
                alpha: 1,
            }
        });
        ...
        this.hitZone = scene.add.zone(this.x, this.y, NodeConnector.LINE_WIDTH, NodeConnector.LINE_WIDTH);
    ...
    protected onPointerEnter() {
        ...
        this.setDefaultStyles({
            lineStyle: {
                width: NodeConnector.LINE_WIDTH,
                color: NodeConnector.HOVER_COLOR
            }
        })
        this.setDirty(true);
    }
            ...
            onUpdate: () => {
                ...
                if (this.dirty || !lastCoordsFrom.equals(coordsFrom) || !lastCoordsTo.equals(coordsTo)) {
                    ...
                    this.hitZone.setSize( // @TODO: calculate from half-sizes
                        Math.max(10, magnitude - NodeConnector.HALF_SUBTRACT_FROM_ZONE_LENGTH * 2),
                        NodeConnector.LINE_WIDTH * NodeConnector.HIT_ZONE_WIDTH_MULTIPLIER,
                        true
                    );
